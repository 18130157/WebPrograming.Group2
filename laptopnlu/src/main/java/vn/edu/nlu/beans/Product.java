...
public class Product implements Serializable {
    ...
    public Product(String id, String name, String img, double price, double priceSale) {
        this.id = id;
        this.name = name;
        this.img = img;
        this.price = price;
    ...
    public Product(String id, String name, String img, double price, double priceSale,double phanTram,int star,int ram, String oCung) {
        this.id = id;
        this.name = name;
        this.img = img;
        this.price = price;
    ...
    public Product(String id, String name, String img, double price, double priceSale, int star,String description, List<Comment> comment, List<Evaluate> evaluate, Connector conector, Cpu cpu, Memory memory, Monitor monitor, OperatingSys o, Size size, Sound sound, Pin pin) {
        this.id = id;
        this.name = name;
        this.img = img;
        this.price = price;
    ...
    public boolean equals(Object o) {
        ...
        return Double.compare(product.price, price) == 0 &&
                Double.compare(product.phanTramKM, phanTramKM) == 0 &&
                Double.compare(product.priceSale, priceSale) == 0 &&
                quantity == product.quantity &&
                star == product.star &&
                ram == product.ram &&
                id.equals(product.id) &&
                name.equals(product.name) &&
                img.equals(product.img) &&
                oCung.equals(product.oCung);
    }
