        ...
        <nav class="navigation">
            <div class="container-fluid">
                ...
                <div class="navigation__column right">
                    <form class="ps-search--header" action="seach" method="post" name="searchProduct" style="width: 200px">
                        <input class="form-control" type="search" id="search"  name="search" placeholder="Tìm kiếm sản phẩm..." onkeyup="searchInfo()">
                        <button><i class="ps-icon-search"></i></button>
                        <div class="clearfix"></div>

                    </form>
                    <span style="position: absolute;z-index: 10;background-color: white" id="mylocation"></span>
