...
public class ProductListEntity {
    ...
    public List<Product3> getAll() {
        ...
        try {
            s = ConnectDB.connect("select * from product");
            ResultSet rs = s.executeQuery();
            LinkedList<Product3> list = new LinkedList<>();
            while (rs.next()) {
                list.add(new Product3(
                        rs.getString(1),
                        rs.getString(2),
                        rs.getString(3),
                        rs.getInt(4),
    ...
    public Product3 getById(String id) {
        PreparedStatement s = null;
        try {
    ...
    public static List<Product3> getRecords(int start, int total) {
        PreparedStatement s = null;
        List<Product3> listProLimit = new LinkedList<Product3>();
        try {
            String sql = "";
    ...
    //get Product with limit
    public static List<Product3> getRecords() {
        PreparedStatement s = null;
        List<Product3> listProLimit = new ArrayList<>();
        try {
            String sql = "";
    ...
    public static int getCount() {
        ...
        int count = 0;
        try {
            s = ConnectDB.connect("select COUNT(*)from product");
            ResultSet rs = s.executeQuery();
            while (rs.next()) {
                count = rs.getInt(1);
            }
    ...
    public static List<Product3> getProductOnBrand(String[] brand) {
        if (brand == null)
            System.out.println("true");
        else System.out.println(brand[0]);
        List<Product3> result = new LinkedList<>();
        PreparedStatement s = null;
        try {
    ...
    public static List<Product3> getProductOnPrice(String priceLow, String priceHigh) {
        List<Product3> result = new LinkedList<>();
        PreparedStatement s = null;
        try {
            String sql = "select *, ROUND(Gia*(1-MucGiamGia),0) AS GiaKM  " +
    ...
    public static List<Product3> getProductOnMonitor(String size1, String size2) {
        List<Product3> result = new LinkedList<>();
        PreparedStatement s = null;
        try {
            String sql = "select *, ROUND(Gia*(1-MucGiamGia),0) AS GiaKM " +
    ...
    public static List<Product3> getProductOnCPU(String[] cpu) {
        List<Product3> result = new LinkedList<>();
        PreparedStatement s = null;
        try {
            String sql = "select *, ROUND(Gia*(1-MucGiamGia),0) AS GiaKM  " +
    ...
    public static List<Product3> getProductOnRAM(String[] ram) {
        List<Product3> result = new LinkedList<>();
        PreparedStatement s = null;
        try {
            String sql = "select *, ROUND(Gia*(1-MucGiamGia),0) AS GiaKM  " +
    ...
    public static List<Product3> getProductOnHardDisk(String[] disk) {
        List<Product3> result = new LinkedList<>();
        PreparedStatement s = null;
        try {
            String sql = "select *, ROUND(Gia*(1-MucGiamGia),0) AS GiaKM  " +
    ...
    public static List<Product3> getProductOnSale(boolean sale) {
        List<Product3> result = new LinkedList<>();
        PreparedStatement s = null;
        try {
            String sql = "select *, ROUND(Gia*(1-MucGiamGia),0) AS GiaKM  " +
    ...
    public static List<Product3> pagination(List<Product3> list, int start, int total) {
    ...
    public static List<Product3> sort(List<Product3> arr, String id) {
        if (arr == null || arr.isEmpty()) System.out.println("list is null");
        if (id.equals("2")) {
            Collections.sort(arr, new Comparator<Product3>() {
                @Override
