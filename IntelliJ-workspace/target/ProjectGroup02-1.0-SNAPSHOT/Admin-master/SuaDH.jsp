                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-lg-10" style="margin: auto">
                             <h3 class="title-5 m-b-35">Sửa thông tin đơn hàng</h3>
                            <div class="card">
                                    ...
                                    <form action="" method="post" class="form-horizontal">
                                        <div class="row form-group">
                                            <div class="col col-md-3">
                                                <label for="hf-ma" class=" form-control-label">Mã ĐH (*):</label>
                                            </div>
                                            <div class="col-12 col-md-9">
                                                <input type="text" id="hf-ma" name="hf-ma" placeholder="Nhập mã đơn hàng..." class="form-control">
                                                <span class="help-block">(*) Bắt buộc</span>
                                            </div>
                                        </div>
                                        <div class="row form-group">
                                            <div class="col col-md-3">
                                                <label for="hf-ten" class=" form-control-label">Tên:</label>
                                            </div>
                                            <div class="col-12 col-md-9">
                                                <input type="text" id="hf-ten" name="hf-ten" placeholder="Nhập tên..." class="form-control">
                                                <span class="help-block">Nhập tên người đặt hàng</span>
                                            </div>
                                        </div>
                                        <div class="row form-group">
                                            <div class="col col-md-3">
                                                <label for="hf-date" class=" form-control-label">Ngày lập:</label>
                                            </div>
                                            <div class="col-12 col-md-9">
                                                <input type="date" id="hf-date" name="hf-date" placeholder="Nhập ngày..." class="form-control">
                                                <span class="help-block">Nhập ngày đặt hàng</span>
                                            </div>
                                        </div>
                                ...
                                <div class="card-footer">
                                    <button type="submit" class="btn btn-primary btn-sm" >
                                       <a href="Edit_DH.html" style="color: white"><i class="fa fa-dot-circle-o"></i>Tìm kiếm và Sửa</a>
                                    </button>
