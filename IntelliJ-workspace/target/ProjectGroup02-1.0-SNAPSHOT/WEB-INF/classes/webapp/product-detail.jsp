                ...
                <div class="col-lg-10 col-md-12 col-lg-offset-1">
                    ...
                    <div class="ps-product__info">
                        <div class="ps-product__rating">
                            <select class="ps-rating">
                                <c:if test="${product.star==1}">
                                    <option value="1" selected>1</option>
                                </c:if>
                                <c:if test="${product.star!=1}">
                                    <option value="1">1</option>
                                </c:if>
                                <c:if test="${product.star==2}">
                                    <option value="2" selected>2</option>
                                </c:if>
                                <c:if test="${product.star!=2}">
                                    <option value="2">2</option>
                                </c:if>
                                <c:if test="${product.star==3}">
                                    <option value="3" selected>3</option>
                                </c:if>
                                <c:if test="${product.star!=3}">
                                    <option value="3">3</option>
                                </c:if>
                                <c:if test="${product.star==4}">
                                    <option value="4" selected>4</option>
                                </c:if>
                                <c:if test="${product.star!=4}">
                                    <option value="4">4</option>
                                </c:if>
                                <c:if test="${product.star==5}">
                        ...
                        <div class="ps-product__block ps-product__size">
                            ...
                            <form method="post" action="AddCart">
                                <div class="form-group row">
                                    ...
                                    <input class="form-control col-lg-4" type="number" name="SL" value="1">
                                </div>
                                <div class="ps-product__shopping">
                                    <button class="ps-btn mb-10">Thêm vào giỏ<i class="ps-icon-next"></i></button>
                                </div>
                            </form>
                    ...
                    <div class="tab-content mb-60" style="background: #FFFFFF">
                        ...
                        <div class="tab-pane" role="tabpanel" id="tab_02">
                            ...
                            <div class="ps-review">
                                <p class="mb-20">${product.evaluate.size()} đánh giá cho
                                ...
                                <c:forEach items="${product.evaluate}" var="eva">
                                    ...
                                    <div class="ps-review__content">
                                        <header>
                                            <select class="ps-rating">
                                                <c:if test="${eva.star==1}">
                                                    <option value="1" selected>1</option>
                                                </c:if>
                                                <c:if test="${eva.star!=1}">
                                                    <option value="1">1</option>
                                                </c:if>
                                                <c:if test="${eva.star==2}">
                                                    <option value="2" selected>2</option>
                                                </c:if>
                                                <c:if test="${eva.star!=2}">
                                                    <option value="2">2</option>
                                                </c:if>
                                                <c:if test="${eva.star==3}">
                                                    <option value="3" selected>3</option>
                                                </c:if>
                                                <c:if test="${eva.star!=3}">
                                                    <option value="3">3</option>
                                                </c:if>
                                                <c:if test="${eva.star==4}">
                                                    <option value="4" selected>4</option>
                                                </c:if>
                                                <c:if test="${eva.star!=4}">
                                                    <option value="4">4</option>
                                                </c:if>
                                                <c:if test="${eva.star==5}">
                                                    <option value="5" selected>5</option>
                                                </c:if>
                                                <c:if test="${eva.star!=5}">
                                                    <option value="5">5</option>
                            ...
                            <form class="ps-product__review" action="evaluate?id=${product.id}" method="post">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 " style="margin-left: 200px">
                                        ...
                                        <div class="form-group">
                                            <button class="ps-btn ps-btn--sm" type="submit">GỬI ĐÁNH GIÁ<i
                        ...
                        <div class="tab-pane" role="tabpanel" id="tab_03">
                            ...
                            <div class="ps-review">
                                ...
                                <p class="mb-20">${product.comment.size()} bình luận cho
                                    <strong>${product.name}</strong></p>
                                <div class="comment">
